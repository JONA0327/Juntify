                            ...
                            <div x-show="mainTab === 'config'" x-transition>
                                <div class="mb-6">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button @click="copyApiKey" :disabled="!apiKey || isCopyingApiKey" class="px-4 py-2 bg-slate-800/50 text-slate-200 rounded-lg border border-slate-700/50 hover:bg-slate-700/50 transition-colors duration-200 disabled:opacity-50">
                                            <span x-show="!isCopyingApiKey" x-text="copyApiKeyLabel"></span>
                                            <span x-show="isCopyingApiKey" class="flex items-center">
                                                <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-slate-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                                </svg>
                                                Copiando...
                                        ...
                                        <button @click="regenerateApiKey" :disabled="isRegeneratingApiKey" class="px-4 py-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-slate-900 rounded-lg font-medium shadow-lg shadow-black/10 hover:from-yellow-500 hover:to-yellow-400 transition-colors duration-200 disabled:opacity-50">
                                            <span x-show="!isRegeneratingApiKey">Regenerar</span>
                                            <span x-show="isRegeneratingApiKey" class="flex items-center">
                                                <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-slate-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                                </svg>
...
GET <?php echo e(route('api.organizations.index')); ?>

POST <?php echo e(route('api.organizations.store')); ?>

PATCH <?php echo e(url('/api/organizations/{id}')); ?>

GET <?php echo e(url('/api/groups/{id}')); ?>

                                </pre>
                                <p class="text-slate-400 mt-2">Recuerda enviar el encabezado Authorization: Bearer &lt;token&gt;</p>
                                <a href="<?php echo e(route('organization.api-guide')); ?>"
