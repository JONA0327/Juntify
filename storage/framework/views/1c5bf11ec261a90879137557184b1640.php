    ...
    <div class="app-container">
        <main class="main-admin">
            ...
            <div class="content-grid">
                <?php $__empty_1 = true; $__currentLoopData = $analyzers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analyzer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="info-card analyzer-card" data-analyzer-id="<?php echo e($analyzer->id); ?>">
                        <div class="analyzer-header">
                            <h3 class="card-title">
                                <span class="card-icon"><?php echo e($analyzer->icon); ?></span>
                                <?php echo e($analyzer->name); ?>

                            </h3>
                            <div class="analyzer-actions">
                                <button class="control-btn" onclick="editAnalyzer('<?php echo e($analyzer->id); ?>')" title="Editar analizador">
                                ...
                                <button class="control-btn delete-btn" onclick="deleteAnalyzer('<?php echo e($analyzer->id); ?>')" title="Eliminar analizador">
                                    <svg class="btn-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="analyzer-description">
                            <p><?php echo e($analyzer->description); ?></p>
                        </div>
                        <div class="analyzer-details">
                            <div class="info-item">
                                <span class="info-label">Tipo</span>
                                <span class="status-badge <?php echo e($analyzer->is_system ? 'status-active' : 'status-inactive'); ?>"><?php echo e($analyzer->is_system ? 'Sistema' : 'Personalizado'); ?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Creado</span>
                                <span class="info-value"><?php echo e($analyzer->created_at->format('d/m/Y')); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\Juntify\resources\views/admin/analyzers.blade.php ENDPATH**/ ?>