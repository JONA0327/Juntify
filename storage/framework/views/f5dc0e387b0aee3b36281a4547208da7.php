    ...
    <div class="flex">
        ...
        <main class="w-full pt-20 lg:pl-24 lg:pt-24 lg:mt-[130px]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <?php echo $__env->make('tasks.partials._header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <div class="mt-8 flex flex-col-reverse lg:grid lg:grid-cols-3 lg:gap-8 items-start">
                    ...
                    <aside class="col-span-1 w-full">
                        <?php echo $__env->make('tasks.partials._sidebar-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <div id="tasks-empty" class="info-card p-6 mt-8 text-center text-slate-300">
...
<?php /**PATH C:\Users\Admin\Desktop\Cerounocero\Juntify\resources\views/tasks/index.blade.php ENDPATH**/ ?>