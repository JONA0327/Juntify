...
<ul class="nav-links" id="nav-links">
  ...
  <li>
    <a href="<?php echo e(route('chats.index')); ?>" class="<?php echo e(request()->routeIs('chats.*') ? 'active' : ''); ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  <?php /* end */ ?>
  <li>
    <a href="<?php echo e(route('ai-assistant')); ?>" class="<?php echo e(request()->routeIs('ai-assistant') ? 'active' : ''); ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<?php /**PATH C:\Users\Admin\Desktop\Cerounocero\Juntify\resources\views/partials/navbar.blade.php ENDPATH**/ ?>