        ...
        <div class="hero-content">
            ...
            <div class="sphere-container">
                ...
                <div class="sphere-text">
                    ...
                    <?php if(Auth::check()): ?>
                        <a href="<?php echo e(route('profile.show')); ?>" class="sphere-btn">Ir a mi perfil</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="sphere-btn">Iniciar Sesión</a>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\goku0\Downloads\Proyectos\Juntify Laravel\Juntify\resources\views/index.blade.php ENDPATH**/ ?>