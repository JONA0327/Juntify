        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-500 rounded-full flex items-center justify-center text-white font-semibold">
                    <?php echo e(substr($otherUser->full_name, 0, 1)); ?>

                </div>
                <div>
                    <h1 class="text-xl font-semibold text-slate-200"><?php echo e($otherUser->full_name); ?></h1>
                    <p class="text-slate-400 text-sm"><?php echo e($otherUser->email); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Juntify\resources\views/contacts/chat.blade.php ENDPATH**/ ?>