...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <?php if(in_array($user->roles, ['superadmin', 'developer'])): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.dashboard')); ?>" onclick="window.location.href='<?php echo e(route('admin.dashboard')); ?>'" class="nav-link <?php echo e(request()->routeIs('admin.analyzers') ? 'active' : ''); ?>">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<?php /**PATH C:\Users\goku0\Downloads\Proyectos\Juntify Laravel\Juntify\resources\views/partials/profile/_sidebar.blade.php ENDPATH**/ ?>