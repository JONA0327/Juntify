// resources/js/admin/analyzers.js

// Ensure Axios sends the CSRF token with requests
...
function editAnalyzer(analyzerId) {
  ...
  axios
    .get(`/admin/analyzers/${analyzerId}`)
    .then(res => {
      const data = res.data;
...
function confirmDeleteAnalyzer() {
  ...
  axios
    .delete(`/admin/analyzers/${deletingAnalyzerId}`)
    .then(response => {
...
window.showCreateAnalyzerModal = showCreateAnalyzerModal;
window.editAnalyzer = editAnalyzer;
window.deleteAnalyzer = deleteAnalyzer;
window.closeAnalyzerModal = closeAnalyzerModal;
window.closeDeleteModal = closeDeleteModal;
window.saveAnalyzer = saveAnalyzer;
window.confirmDeleteAnalyzer = confirmDeleteAnalyzer;
