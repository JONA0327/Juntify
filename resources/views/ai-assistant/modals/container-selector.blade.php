...
<div id="contextSelectorModal" class="modal">
    <div class="modal-backdrop" onclick="closeContextSelector()"></div>
        ...
        <div class="modal-body context-selector-body">
            ...
            <div class="context-content">
                ...
                <div id="containersView" class="context-view active">
                    ...
                    <!-- Widget de archivos del contenedor seleccionado -->
                    <div id="containerFilesWidget" style="display:none;margin-top:1rem;">
                        <h4 style="margin-bottom:.5rem;">Archivos del Contenedor</h4>
                        <div style="display:flex;gap:.75rem;flex-wrap:wrap;margin-bottom:.5rem;">
                            <button class="btn btn-primary" type="button" onclick="triggerContainerFileUpload()">Subir Archivo (max 150MB)</button>
                            <button class="btn btn-secondary" type="button" onclick="refreshContainerFiles()">Ver/Actualizar Lista</button>
                        </div>
                        <input type="file" id="containerFileInput" style="display:none;" onchange="uploadContainerFile(this.files)" />
                        <div id="containerFilesStatus" class="text-sm" style="margin:.5rem 0;color:#555;"></div>
                        <table class="table" style="width:100%;border-collapse:collapse;" id="containerFilesTable">
                            <thead>
...
// Suponiendo que en otro lugar ya seleccionas contenedor -> añade integración:
function setActiveContainerForFiles(containerId){
    currentSelectedContainerId = containerId;
    document.getElementById('containerFilesWidget').style.display = 'block';
...
function triggerContainerFileUpload(){
    ...
    document.getElementById('containerFileInput').value='';
    document.getElementById('containerFileInput').click();
}
