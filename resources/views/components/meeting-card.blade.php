    ...
    <div class="meeting-card-header">
        <div class="meeting-header-top">
            ...
            <div class="meeting-actions">
                ...
                <button type="button" class="share-btn icon-btn" onclick="document.getElementById('shareModal') && openShareModal({{ $id }})" aria-label="Compartir reunión" title="Compartir reunión" data-is-legacy="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
