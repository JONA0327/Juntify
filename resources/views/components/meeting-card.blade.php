...
<div class="meeting-card" data-meeting-id="{{ $id }}" draggable="true">
    <div class="meeting-card-header">
        ...
        <div class="meeting-actions">
            ...
            <button class="share-btn icon-btn" onclick="openShareModal({{ $id }})" aria-label="Compartir reunión" title="Compartir reunión">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <button class="icon-btn delete-btn" onclick="deleteMeeting({{ $id }})" aria-label="Eliminar reunión" title="Eliminar reunión">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div class="absolute bottom-4 right-4 flex gap-2">
        <button class="download-btn icon-btn" aria-label="Descargar reunión" title="Descargar reunión">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2 0 002 2h12a2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4" />
            </svg>
        </button>
    </div>
</div>
