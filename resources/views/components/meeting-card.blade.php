    ...
    <div class="meeting-card-header">
        <div class="meeting-header-top">
            ...
            <div class="meeting-actions">
                <button type="button" class="icon-btn container-btn" onclick="openContainerSelectModal({{ $id }})" aria-label="Añadir a contenedor" title="Añadir a contenedor">
                ...
                <button type="button" class="share-btn icon-btn" onclick="(function(btn){ if(!document.getElementById('shareModal')) return; var isLegacy = btn.getAttribute('data-is-legacy') === 'true'; openShareModal({{ $id }}, isLegacy); })(this)" aria-label="Compartir reunión" title="Compartir reunión" data-is-legacy="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z" />
                    </svg>
                </button>
                <button type="button" class="icon-btn edit-btn" onclick="editMeetingName({{ $id }})" aria-label="Editar reunión" title="Editar nombre de reunión">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                </button>
                <button type="button" class="icon-btn delete-btn" onclick="deleteMeeting({{ $id }})" aria-label="Eliminar reunión" title="Eliminar reunión">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
