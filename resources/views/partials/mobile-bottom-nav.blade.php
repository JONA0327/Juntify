...
">
    ...
    <div class="nav-item more-options-container">
        ...
        <div class="more-dropdown" id="more-dropdown">
            <a class="more-item" href="{{ route('contacts.index') }}">
            ...
            <a class="more-item" href="{{ route('organization.index') }}">
                <svg class="more-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a class="more-item" href="{{ route('profile.show') }}">
                <svg class="more-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a class="more-item" href="{{ route('admin.dashboard') }}">
                <svg class="more-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Cerrar el dropdown al seleccionar una opción y permitir navegación por href
