...
<aside class="sidebar" id="sidebar">
    <button class="sidebar-close-btn" onclick="closeSidebar()" aria-label="{{ __('common.close_menu') }}">
    ...
    <div class="sidebar-header">
        ...
        <p class="logo-subtitle">{{ __('profile.sidebar.subtitle') }}</p>
    </div>
    ...
    <div class="sidebar-footer">
        <div class="version-info">
            {{ __('profile.sidebar.version', ['version' => 'Juntify 2.0']) }}
        </div>
    </div>
</aside>
