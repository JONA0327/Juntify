    ...
    <div class="meeting-recorder-container">
        ...
        <div class="recorder-controls" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
            <div class="microphone-container">
                <button type="button" class="mic-circle" id="meeting-record-btn" onclick="toggleMeetingRecording()" aria-label="Iniciar o detener grabación de reunión">
                    <svg class="nav-icon-giant" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="recorder-actions" id="meeting-actions">
                <button class="icon-btn" id="meeting-pause" onclick="pauseRecording()" style="display: none;" aria-label="Pausar grabación">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
                    </svg>
                </button>
                <button class="icon-btn" id="meeting-resume" onclick="resumeRecording()" style="display: none;" aria-label="Reanudar grabación">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.25l13.5 6.75-13.5 6.75V5.25z" />
                    </svg>
                </button>
                <button class="icon-btn" id="meeting-discard" onclick="discardRecording()" style="display: none;" aria-label="Descartar grabación">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
