...
echo "=== TESTING API CON USUARIO DE GRUPO ===\n\n";

// Obtener un usuario que SÍ pertenezca a un grupo
$user = User::where('email', 'jona03278@gmail.com')->first();

if (!$user) {
    echo "❌ Usuario del grupo no encontrado\n";
    exit;
}
...
echo "=== EJECUTANDO API CON USUARIO DE GRUPO ===\n";
